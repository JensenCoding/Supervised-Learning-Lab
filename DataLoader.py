...
class DataLoader:
    ...
    def get_scaled_data(self):
        ...
        training_x = StandardScaler().fit_transform(self.training_x)
        testing_x = StandardScaler().fit_transform(self.testing_x)
        return X, self.Y, training_x, self.training_y, testing_x, self.testing_y
